...
boolean GPS::LOCUS_StartLogger(void) 
{
...
boolean GPS::LOCUS_StopLogger(void) 
{
...
boolean GPS::LOCUS_ReadStatus(void) 
{
...
{
  if(minute < 10)
    return "\nTime: " + String(hour) + ":0" + String(minute) + ":" + String(seconds) + "." + String(milliseconds);
  else
    return "\nTime: " + String(hour) + ":" + String(minute) + ":" + String(seconds) + "." + String(milliseconds);
}
...
String GPS::get_location()
{
  return "Location: " + String(latitude) + String(lat) + ", " + String(longitude) + String(lon);
}

String GPS::get_speed()
{
  return "Speed (knots): " + String(speed);
}

String GPS::get_altitude()
{
  return "Altitude: " + String(altitude);
}

String GPS::get_satellites()
{
  return "Satellites: " + String(satellites);
}
