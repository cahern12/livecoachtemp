...
String Compass::get_heading()
{
  return "Heading: " + String((float)heading/10.0);
}
String Compass::get_pitch()
{
  return "Pitch: " + String((float)pitch/10.0);
}
String Compass::get_roll()
{
  return "Roll: " + String((float)roll/10.0);
}
String Compass::get_temp()
{
  return "Temp: " + String((float)temperature/10.0);
}
